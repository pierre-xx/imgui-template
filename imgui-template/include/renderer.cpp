...
bool Renderer::init() {
    ...
    int sWidth = rc.right - rc.left;
    int sHeight = rc.bottom - rc.top;

    hwnd = ::CreateWindowEx(WS_EX_LAYERED, _T("ImGui Example"), NULL, WS_POPUP, 0, 0, sWidth, sHeight, NULL, NULL, wc.hInstance, NULL);
